...
\begin{document}
    ...
    \[
        \int e^{\pm x^2} \, dx, \quad \int \frac{dx}{\ln x}, \quad \int \frac{e^x}{x} \, dx, \quad \int \frac{\sin x}{x} \, dx, \quad \int \frac{\sinh x}{x} \, dx, \quad \int \ln (\ln x) \, dx
    \]
    ...
    \begin{itemize}
        \item Derive these integrals as a consequence of a more general result.
        \item Introduce and prove a powerful tool for understanding this phenomenon: \textbf{Liouville's theorem}.
        \item If time permits, discuss \textbf{elliptic integrals}, which also cannot be expressed in elementary terms.
    \end{itemize}
    \end{frame}
