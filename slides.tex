    ...
    \begin{frame}{On elliptic integrals}
        ...
        \begin{proof}<2->
            ...
            \uncover<4->{
                ...
                But such type of the forms cannot be expressed as a linear combination of a logarithmic meromorphic differentials $du/u$ and exact meromorphic differentials $dv$.
            }
        \end{proof}
