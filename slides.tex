...
\begin{frame}{Liouville's Theorem (statement)}
    \begin{theorem}[Liouville (1833-1841)]
        Let $F$ be the differential field, and $K$ is its subfield of constants. 
        If for $\alpha\in F$ equation $x' = \alpha$ has the solution in some differential extension of $F$, then
        \[
            a = \sum\limits_{i=1}^m c_i \frac{u_i'}{u_i} + v'
        \]
