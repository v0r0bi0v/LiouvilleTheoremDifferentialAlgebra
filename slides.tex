...
\begin{document}
    ...
    \begin{frame}{$t$ is algebraic}
        ...
        \uncover<5->{
            \begin{block}{Remark}
                Here we used that algebraic extension can be equipped wit the unique differentiation, but it's trivial for the case of meromorphic functions.
            \end{block}
        }
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{proof}<4->
            ...
            \uncover<5->{
                After some considirations using the main lemma we will deduce
                \[
                    \frac{1}{x} = a' + a
                \]
                where $a\in F$.
                
                But it's quite clear that it's impossible.
            }
        \end{proof}
    \end{frame}
